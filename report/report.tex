...
StandardScaler was applied to all 45 numerical features (the 20 original continuous and count features with the 25 newly engineered domain features) to ensure uniform scale without distorting binary indicators. Feature selection retained the top-50 features by tree-based importance out of 61 candidates after target encoding.
\begin{figure}[H]
\centering
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../data/plots/03_tsne_2d_perplexity_comparison.png}
\caption{t-SNE 2D projections at perplexity = 5, 30, 50, 100.}
\label{fig:tsne_perplexity}
\end{figure}

The 3D projection (Figure~\ref{fig:tsne_combined}) provides additional spatial separation, further reducing overlap between Graduate and Dropout clusters, though the Enrolled class remains dispersed.

\begin{figure}[H]
\centering
\includegraphics[width=0.49\linewidth]{../data/plots/04_tsne_2d_best.png}
\includegraphics[width=0.49\linewidth]{../data/plots/05_tsne_3d_best.png}
